<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        <image class="loading-bg" resize="contain" src="http://h5.sumslack.com/logo57.png"></image>
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">一</text>
            <text ref="lTxt2" class="l-txt l-txt-2">拍</text>
            <text ref="lTxt3" class="l-txt l-txt-3">即</text>
            <text ref="lTxt4" class="l-txt l-txt-4">达</text>
            <text ref="lTxt5" class="l-txt l-txt-5">金</text>
            <text ref="lTxt6" class="l-txt l-txt-6">融</text>
            <text ref="lTxt7" class="l-txt l-txt-7">词</text>
            <text ref="lTxt8" class="l-txt l-txt-8">条</text>
        </div>
    </refresh>
</template>
<style scoped>
